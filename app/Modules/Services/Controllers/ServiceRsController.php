...
class ServiceRsController extends Controller
{
    ...
    public function serviceSendRsOverheadReturn($data, $address_data, $driver_data, $order_data) {
    ...
    public function serviceSendRsOverhead($data, $order_data) {
        $order_data = json_decode($order_data);
    ...
    public function serviceGetErrorCOdes() {
        $soap_url = "https://services.rs.ge/WayBillService/WayBillService.asmx?op=get_error_codes";
        $post_fields = '<?xml version="1.0" encoding="utf-8"?>
                            <soap12:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://www.w3.org/2003/05/soap-envelope">
                              <soap12:Body>
